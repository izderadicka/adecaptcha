...
class MainDialog(QDialog, sampletool_dialog.Ui_Dialog):
    def __init__(self, parent=None):
        ...
        self.sizeMinEdit.setValidator(QDoubleValidator(self))
        self.tresholdEdit.setValidator(QDoubleValidator(self))
        self.silenceEdit.setValidator(QDoubleValidator(self))
    ...
    def restore_state(self):
        ...
        self.sizeMinEdit.setText(settings.value('seg_size_min').toString() or '0.2')
        self.tresholdEdit.setText(settings.value('threshold').toString() or '5')
        self.silenceEdit.setText(settings.value('silence').toString() or '0.1')
